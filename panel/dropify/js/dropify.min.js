...
!function (e, i)
{ "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof exports ? module.exports = i(require("jquery")) : e.Dropify = i(e.jQuery) }(this, function (e)
{
    function i(i, t)
    {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                showErrors: !0,
                errorTimeout: 3e3,
                errorsPosition: "overlay", imgFileExtensions: ["jpg", "jpeg"],
                ...
                messages: {
                    ...
                    remove: "Remove", error: "Ooops, something wrong appended."
                }, error: {
                    fileSize: "Seçtiðiniz Dosya Çok Büyük (Maksimum {{ value }} Boyutunda Olmalýdýr ).",

                    minWidth: "Bu Resmin Minumum Geniþliði ({{ value }}}px Olmalýdýr).",
                    maxWidth: "Bu Resmin Maksimum  Geniþliði ({{ value }}}px Olmalýdýr).",

                    minHeight: "Bu Resmin Maksimum Yüksekliði ({{ value }}}px Olmalýdýr).",
                    maxHeight: "Bu resmin Minumum Yüksekliði ({{ value }}px Olmalýdýr).",
                ...
                tpl: {
                    ...
                    message: '<div  class="dropify-message"><span class="file-icon" style="color:#000" /> <div style="color:#000">{{ default }}</div></div>',
                ...
                this.wrapper = null, this.preview = null,
