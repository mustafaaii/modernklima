...
The default version of SCAYT plugin for CKEditor 4 is using the free sellers of WebSpellChecker. It is provided with a banner ad and has some [limitations](https://docs.webspellchecker.net/display/WebSpellCheckerCloud/Free+and+Paid+WebSpellChecker+Cloud+sellers+Comparison+for+CKEditor).
...
The SCAYT plugin for CKEditor as a part of the free sellers supports the next languages for check spelling: American English, British English, Canadian English, Canadian French, Danish, Dutch, Finnish, French, German, Greek, Italian, Norwegian Bokmal, Spanish, Swedish.
